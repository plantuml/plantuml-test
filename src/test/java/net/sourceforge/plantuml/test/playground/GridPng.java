...
public class GridPng {

	private static final int CELL_MARGIN = 3;
	private static final float FONT_SIZE = 20;

	public static void writeGridAsPng(Grid grid, String filename) throws IOException {
		final SFile outputFile = PLAYGROUND_OUTPUT_DIR.file(filename + ".png");
	...
	private static BufferedImage step1_prepareCells(Grid grid) {
